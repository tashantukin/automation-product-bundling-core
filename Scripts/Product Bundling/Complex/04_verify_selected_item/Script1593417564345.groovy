...
WebUI.verifyElementText(findTestObject('Item Upload/button_Product bundling'), 'PRODUCT BUNDLING (3)')

WebUI.callTestCase(findTestCase('Utilities/Seller/Logout'), [:], FailureHandling.STOP_ON_FAILURE)
