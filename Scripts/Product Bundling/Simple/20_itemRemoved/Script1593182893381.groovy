...
WebUI.waitForElementPresent(findTestObject('Item Upload/item_selected 1'), 0)

WebUI.verifyElementPresent(findTestObject('Item Upload/item_selected 1'), 0)

WebUI.click(findTestObject('Item Upload/button_remove'))

WebUI.verifyElementNotPresent(findTestObject('Item Upload/item_selected 1'), 0)
