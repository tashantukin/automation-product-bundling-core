...
WebUI.setText(findTestObject('Page_diagnostics/input_search'), 'Sample Item')
...
WebUI.click(findTestObject('Page_diagnostics/button_delete'))

WebUI.click(findTestObject('Page_diagnostics/button_Delete_alert'))
