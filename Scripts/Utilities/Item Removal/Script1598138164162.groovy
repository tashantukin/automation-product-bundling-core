...
WebUI.waitForElementVisible(findTestObject('removeItem/delete_1'), 0)

WebUI.click(findTestObject('removeItem/delete_1'))

WebUI.click(findTestObject('removeItem/delete_2'))
