...
WebUI.selectOptionByLabel(findTestObject('admin_txn_details/dropdown_orders'), 'PO Created', false)

WebUI.delay(3)

WebUI.back()

WebUI.verifyElementText(findTestObject('admin_txn_list/label_order_status'), 'PO Created')
