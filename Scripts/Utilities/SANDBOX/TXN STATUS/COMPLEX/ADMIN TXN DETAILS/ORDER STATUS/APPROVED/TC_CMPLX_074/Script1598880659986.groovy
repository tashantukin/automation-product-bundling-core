...
WebUI.selectOptionByLabel(findTestObject('admin_txn_details/dropdown_orders'), 'Approved', false)

WebUI.delay(3)

WebUI.back()

WebUI.verifyElementText(findTestObject('admin_txn_list/label_order_status'), 'Approved')
