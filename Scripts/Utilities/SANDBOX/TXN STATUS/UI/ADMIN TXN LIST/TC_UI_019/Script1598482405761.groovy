...
WebUI.verifyElementPresent(findTestObject('admin_txn_list/header_paymentstatus'), 0)

WebUI.verifyElementText(findTestObject('admin_txn_list/header_paymentstatus'), 'Payment Status')
