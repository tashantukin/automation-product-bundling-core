...
WebUI.setText(findTestObject('navigate_to_merchant/input_Filter by_keywords'), GlobalVariable.buyer_name)

WebUI.click(findTestObject('navigate_to_merchant/input_Merchant_search_btn'))

WebUI.waitForElementVisible(findTestObject('navigate_to_buyer/a_Login'), 0)

WebUI.click(findTestObject('navigate_to_buyer/a_Login'))

WebUI.waitForElementVisible(findTestObject('navigate_to_buyer/popup'), 0)

WebUI.click(findTestObject('navigate_to_buyer/input_Dont show me this again_mybtn btn-blue'))
